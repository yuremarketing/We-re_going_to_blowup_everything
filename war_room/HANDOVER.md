...
* **Turno Atual**: `Usuário` 🧑
* **Próximo Turno**: A definir — issues #2 (arte 3D) e #5 (performance em device) seguem bloqueadas em fatores externos (Felipe Pessanha e disponibilidade de device físico limpo, respectivamente); nenhuma tarefa de código disponível pra Claudão/Antigravity até uma delas destravar, ou até o Usuário apontar novo trabalho.
